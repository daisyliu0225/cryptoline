proc BarrettMul_n_1 (
  %a_reg@int32[4], %b_reg@int32[4], %mul_reg@int32[4], %prime@int32[4], 
  int32 Q, int32 NQ; %result@int32[4]
) = 
{
  ...
  and [
    Q = 133199617@32, 
    NQ = (-133199617)@32,
    [(-1207885833)@32, (-1207885833)@32, (-1207885833)@32, (-1207885833)@32] <s %a_reg,
    %a_reg <s [1207885833@32, 1207885833@32, 1207885833@32, 1207885833@32]
  ] 
}

broadcast %b_scalar 4 [%b_reg[0]];
broadcast %m_scalar 4 [%mul_reg[0]]; 

// sqrdmulh 運算
mulj %mm %a_reg %m_scalar; 
shl %mm %mm [1@int64, 1@int64, 1@int64, 1@int64];
spl %mm %dc %mm 31; 
add %mm_h2 %mm [1@int33,1@int33,1@int33,1@int33];
spl %v26 %dc %mm_h2 1;

// mul 運算 (使用廣播後的 b_scalar)
mull %dc %tmp_v0 %a_reg %b_scalar; 
cast [] %result@int32[4] %tmp_v0; 

// mls 運算
mov [m, _, _, _] %prime; 
mov %prime_vec [m, m, m, m];
mull %dc %mm_mls %v26 %prime_vec; 
cast [] %mm_mls_32@int32[4] %mm_mls; 
subs %dc %result %result %mm_mls_32;

{
  eqmod %result (%a_reg * [%b_reg[0], %b_reg[0], %b_reg[0], %b_reg[0]]) [Q,Q,Q,Q]
  prove with [algebra solver isl, precondition]
  &&
  true
}

proc BarrettMul_n (%a_reg@int32[4], %b_reg@int32[4], int32 Q, int32 NQ; %result@int32[4]) 
= 
{
       and [Q = 133199617, NQ = -133199617, 
       or[
       %b_reg = [41266039, 41266039, 41266039, 41266039], 
       %b_reg = [78540094, 78540094, 78540094, 78540094], 
       %b_reg = [60096819, 60096819, 60096819, 60096819]
       ]
       ]
&&
       and [Q = 133199617@32, NQ = (-133199617)@32, 
       or [
       %b_reg = [41266039@32, 41266039@32, 41266039@32, 41266039@32], 
       %b_reg = [78540094@32, 78540094@32, 78540094@32, 78540094@32], 
       %b_reg = [60096819@32, 60096819@32, 60096819@32, 60096819@32]
       ]
       ]
}

nondet %result@int32[4];

assume eqmod %result (%a_reg * [%b_reg[0], %b_reg[0], %b_reg[0], %b_reg[0]]) [Q,Q,Q,Q]
&& true;

{
  ...
  prove with [algebra solver isl, precondition]
  &&
  [3@32*NQ,3@32*NQ,3@32*NQ,3@32*NQ]<s %result * [2@32, 2@32, 2@32, 2@32] /\ 
  %result * [2@32, 2@32, 2@32, 2@32] <s [3@32*Q,3@32*Q,3@32*Q,3@32*Q]
}
...
call BarrettMul_n(%v20, %v1, Q, NQ; %v20);
call BarrettMul_n(%v22, %v1, Q, NQ; %v22);
...
call BarrettMul_n(%v10, %v1, Q, NQ; %v10);
call BarrettMul_n(%v13, %v3, Q, NQ; %v13);
call BarrettMul_n(%v14, %v5, Q, NQ; %v14);
