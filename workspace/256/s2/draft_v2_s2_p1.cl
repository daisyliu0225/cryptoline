...
) =
{
  ...
  [3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2,3*NQ+NQ2] < [Ae8,Ae9,Aea,Aeb,Aec,Aed,Aee,Bef] /\ 
...
ghost %v19o0@int32[4], %v20o0@int32[4], %v21o0@int32[4], %v22o0@int32[4]:
  %v19o0 = %v19 /\ %v20o0 = %v20 /\ %v21o0 = %v21 /\ %v22o0 = %v22
  && %v19o0 = %v19 /\ %v20o0 = %v20 /\ %v21o0 = %v21 /\ %v22o0 = %v22;
...
assert eqmod %v19 (%v19o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v20 (%v20o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v21 (%v21o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
...
assume eqmod %v19 (%v19o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v20 (%v20o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v21 (%v21o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v22 (%v22o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       [6*NQ,6*NQ,6*NQ,6*NQ] < %v15 /\ %v15 < [6*Q,6*Q,6*Q,6*Q] /\
...
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    eqmod %v19 (%v19o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v20 (%v20o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v21 (%v21o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v22 (%v22o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    [6*NQ,6*NQ,6*NQ,6*NQ] < %v15 /\ %v15 < [6*Q,6*Q,6*Q,6*Q] /\
...
ghost %v15o0@int32[4], %v16o0@int32[4], %v17o0@int32[4], %v18o0@int32[4],
       %v19o1@int32[4],%v20o1@int32[4],%v21o1@int32[4],%v22o1@int32[4]:
       %v15o0 =  %v15 /\  %v16o0 =  %v16 /\  %v17o0 =  %v17 /\  %v18o0 =  %v18 /\
       %v19o1 =  %v19 /\ %v20o1 = %v20 /\ %v21o1 = %v21 /\ %v22o1 = %v22
   &&  %v15o0 =  %v15 /\  %v16o0 =  %v16 /\  %v17o0 =  %v17 /\  %v18o0 =  %v18 /\
       %v19o1 =  %v19 /\ %v20o1 = %v20 /\ %v21o1 = %v21 /\ %v22o1 = %v22;
...
(* CUT 1 *)
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    %v19 = %v15o0 - %v19o1 /\ %v20 = %v16o0 - %v20o1 /\ 
    %v21 = %v17o0 - %v21o1 /\ %v22 = %v18o0 - %v22o1 /\
    %v23 = %v15o0 + %v19o1 /\ %v24 = %v16o0 + %v20o1 /\
    %v25 = %v17o0 + %v21o1 /\ %v26 = %v18o0 + %v22o1 /\
...
ghost %v21o2@int32[4], %v22o2@int32[4], %v25o1@int32[4], %v26o1@int32[4]:
  %v21o2 = %v21 /\ %v22o2 = %v22 /\ %v25o1 = %v25 /\ %v26o1 = %v26
  && %v21o2 = %v21 /\ %v22o2 = %v22 /\ %v25o1 = %v25 /\ %v26o1 = %v26;
...
assert eqmod %v21 (%v21o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
       eqmod %v22 (%v22o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
       eqmod %v25 (%v25o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
       eqmod %v26 (%v26o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
       [7*NQ,7*NQ,7*NQ,7*NQ] < %v19 /\ %v19 < [7*Q,7*Q,7*Q,7*Q] /\
       [7*NQ,7*NQ,7*NQ,7*NQ] < %v20 /\ %v20 < [7*Q,7*Q,7*Q,7*Q] /\
       [7*NQ,7*NQ,7*NQ,7*NQ] < %v23 /\ %v23 < [7*Q,7*Q,7*Q,7*Q] /\
       [7*NQ,7*NQ,7*NQ,7*NQ] < %v24 /\ %v24 < [7*Q,7*Q,7*Q,7*Q] /\
...
assume eqmod %v21 (%v21o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
       eqmod %v22 (%v22o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
       eqmod %v25 (%v25o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
       eqmod %v26 (%v26o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
       [7*NQ,7*NQ,7*NQ,7*NQ] < %v19 /\ %v19 < [7*Q,7*Q,7*Q,7*Q] /\
...
(* CUT 2 *)
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    eqmod %v21 (%v21o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
    eqmod %v22 (%v22o2*[%v5[0], %v5[0], %v5[0], %v5[0]]) [Q,Q,Q,Q] /\
    eqmod %v25 (%v25o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
    eqmod %v26 (%v26o1*[%v3[0], %v3[0], %v3[0], %v3[0]]) [Q,Q,Q,Q] /\
    %v19 = %v15o0 - %v19o1 /\ %v20 = %v16o0 - %v20o1 /\ 
...
ghost %v19o2@int32[4], %v20o2@int32[4], %v21o3@int32[4], %v22o3@int32[4],
       %v23o0@int32[4],%v24o0@int32[4],%v25o2@int32[4],%v26o2@int32[4]:
       %v19o2 =  %v19 /\  %v20o2 =  %v20 /\  %v21o3 =  %v21 /\  %v22o3 =  %v22 /\
       %v23o0 =  %v23 /\ %v24o0 = %v24 /\ %v25o2 = %v25 /\ %v26o2 = %v26
   &&  %v19o2 =  %v19 /\  %v20o2 =  %v20 /\  %v21o3 =  %v21 /\  %v22o3 =  %v22 /\
       %v23o0 =  %v23 /\ %v24o0 = %v24 /\ %v25o2 = %v25 /\ %v26o2 = %v26;
...
(* CUT 3 *)
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    %v15 = %v23o0 + %v25o2 /\ %v16 = %v23o0 - %v25o2 /\ 
    %v17 = %v24o0 + %v26o2 /\ %v18 = %v24o0 - %v26o2 /\
    %v23 = %v19o2 + %v21o3 /\ %v24 = %v19o2 - %v21o3 /\
    %v25 = %v20o2 + %v22o3 /\ %v26 = %v20o2 - %v22o3 /\
...
ghost %v17o1@int32[4], %v18o1@int32[4], %v25o3@int32[4], %v26o3@int32[4]:
  %v17o1 = %v17 /\ %v18o1 = %v18 /\ %v25o3 = %v25 /\ %v26o3 = %v26
  && %v17o1 = %v17 /\ %v18o1 = %v18 /\ %v25o3 = %v25 /\ %v26o3 = %v26;
...
assert eqmod %v17 (%v17o1*[%v7[0], %v7[0], %v7[0], %v7[0]]) [Q,Q,Q,Q] /\
       eqmod %v18 (%v18o1*[%v8[0], %v8[0], %v8[0], %v8[0]]) [Q,Q,Q,Q] /\
       eqmod %v25 (%v25o3*[%v9[0], %v9[0], %v9[0], %v9[0]]) [Q,Q,Q,Q] /\
       eqmod %v26 (%v26o3*[%v10[0], %v10[0], %v10[0], %v10[0]]) [Q,Q,Q,Q] /\
       [8*NQ,8*NQ,8*NQ,8*NQ] < %v15 /\ %v15 < [8*Q,8*Q,8*Q,8*Q] /\
       [8*NQ,8*NQ,8*NQ,8*NQ] < %v16 /\ %v16 < [8*Q,8*Q,8*Q,8*Q] /\
       [8*NQ,8*NQ,8*NQ,8*NQ] < %v23 /\ %v23 < [8*Q,8*Q,8*Q,8*Q] /\
       [8*NQ,8*NQ,8*NQ,8*NQ] < %v24 /\ %v24 < [8*Q,8*Q,8*Q,8*Q] /\
...
assume eqmod %v17 (%v17o1*[%v7[0], %v7[0], %v7[0], %v7[0]]) [Q,Q,Q,Q] /\
       eqmod %v18 (%v18o1*[%v8[0], %v8[0], %v8[0], %v8[0]]) [Q,Q,Q,Q] /\
       eqmod %v25 (%v25o3*[%v9[0], %v9[0], %v9[0], %v9[0]]) [Q,Q,Q,Q] /\
       eqmod %v26 (%v26o3*[%v10[0], %v10[0], %v10[0], %v10[0]]) [Q,Q,Q,Q] /\
       [8*NQ,8*NQ,8*NQ,8*NQ] < %v15 /\ %v15 < [8*Q,8*Q,8*Q,8*Q] /\
...
(* CUT 4 *)
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    eqmod %v17 (%v17o1*[%v7[0], %v7[0], %v7[0], %v7[0]]) [Q,Q,Q,Q] /\
    eqmod %v18 (%v18o1*[%v8[0], %v8[0], %v8[0], %v8[0]]) [Q,Q,Q,Q] /\
    eqmod %v25 (%v25o3*[%v9[0], %v9[0], %v9[0], %v9[0]]) [Q,Q,Q,Q] /\
    eqmod %v26 (%v26o3*[%v10[0], %v10[0], %v10[0], %v10[0]]) [Q,Q,Q,Q] /\
    %v15 = %v23o0 + %v25o2 /\ %v16 = %v23o0 - %v25o2 /\ 
...
ghost %v15o1@int32[4], %v16o1@int32[4], %v17o2@int32[4], %v18o2@int32[4],
       %v23o1@int32[4],%v24o1@int32[4],%v25o4@int32[4],%v26o4@int32[4]:
       %v15o1 =  %v15 /\  %v16o1 =  %v16 /\  %v17o2 =  %v17 /\  %v18o2 =  %v18 /\
       %v23o1 =  %v23 /\ %v24o1 = %v24 /\ %v25o4 = %v25 /\ %v26o4 = %v26
   &&  %v15o1 =  %v15 /\  %v16o1 =  %v16 /\  %v17o2 =  %v17 /\  %v18o2 =  %v18 /\
       %v23o1 =  %v23 /\ %v24o1 = %v24 /\ %v25o4 = %v25 /\ %v26o4 = %v26;
