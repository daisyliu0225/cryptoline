...
ghost %v19_s2l1_o0@int32[4], %v20_s2l1_o0@int32[4], %v21_s2l1_o0@int32[4], %v22_s2l1_o0@int32[4]:
  %v19_s2l1_o0 = %v19 /\ %v20_s2l1_o0 = %v20 /\ %v21_s2l1_o0 = %v21 /\ %v22_s2l1_o0 = %v22
  && %v19_s2l1_o0 = %v19 /\ %v20_s2l1_o0 = %v20 /\ %v21_s2l1_o0 = %v21 /\ %v22_s2l1_o0 = %v22;
...
assert eqmod %v19 (%v19_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v20 (%v20_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v21 (%v21_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v22 (%v22_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
...
assume eqmod %v19 (%v19_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v20 (%v20_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v21 (%v21_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       eqmod %v22 (%v22_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
       [6*NQ,6*NQ,6*NQ,6*NQ] < %v15 /\ %v15 < [6*Q,6*Q,6*Q,6*Q] /\
...
cut Q = 133199617 /\ Q2 = 66599809 /\ NQ = -133199617 /\ NQ2 = -66599809 /\
    eqmod %v19 (%v19_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v20 (%v20_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v21 (%v21_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    eqmod %v22 (%v22_s2l1_o0*[%v1[0], %v1[0], %v1[0], %v1[0]]) [Q,Q,Q,Q] /\
    [6*NQ,6*NQ,6*NQ,6*NQ] < %v15 /\ %v15 < [6*Q,6*Q,6*Q,6*Q] /\
