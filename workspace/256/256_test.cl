...
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdeb0; Value = 0x0000000100000000; PC = 0x555555550bb0 *)
...
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf30; Value = 0x0000002100000020; PC = 0x555555550bc0 *)
...
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffdfb0; Value = 0x0000004100000040; PC = 0x555555550bd0 *)
...
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe030; Value = 0x0000006100000060; PC = 0x555555550be0 *)
...
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe0b0; Value = 0x0000008100000080; PC = 0x555555550bf0 *)
...
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe130; Value = 0x000000a1000000a0; PC = 0x555555550c00 *)
...
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe1b0; Value = 0x000000c1000000c0; PC = 0x555555550c10 *)
...
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe230; Value = 0x000000e1000000e0; PC = 0x555555550c20 *)
...
sub %v10 %v17 %v21;
(* sqrdmulh	v26.4s, v20.4s, v2.s[0]                #! PC = 0x555555550c54 *)
...
add %v26 %LO11 %LO01;
(* mul	v20.4s, v20.4s, v1.s[0]                     #! PC = 0x555555550c58 *)
broadcast %mul 4 [%v1[0]]; mul %v20 %v20 %mul;
(* mls	v20.4s, v26.4s, v0.4s                       #! PC = 0x555555550c5c *)
mull %dc %mls %v26 %v0; sub %v20 %v20 %mls;
(* sqrdmulh	v26.4s, v22.4s, v2.s[0]                #! PC = 0x555555550c60 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v22 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v22.4s, v22.4s, v1.s[0]                     #! PC = 0x555555550c64 *)
broadcast %mul 4 [%v1[0]]; mul %v22 %v22 %mul;
(* mls	v22.4s, v26.4s, v0.4s                       #! PC = 0x555555550c68 *)
...
sub %v14 %v18 %v22;
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdeb0; PC = 0x555555550c80 *)
mov L0x7fffffffdeb0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf30; PC = 0x555555550c88 *)
mov L0x7fffffffdf30 v25;
(* sqrdmulh	v26.4s, v10.4s, v2.s[0]                #! PC = 0x555555550c8c *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v10 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v10.4s, v10.4s, v1.s[0]                     #! PC = 0x555555550c90 *)
broadcast %mul 4 [%v1[0]]; mul %v10 %v10 %mul;
(* mls	v10.4s, v26.4s, v0.4s                       #! PC = 0x555555550c94 *)
mull %dc %mls %v26 %v0; sub %v10 %v10 %mls;
(* sqrdmulh	v26.4s, v13.4s, v4.s[0]                #! PC = 0x555555550c98 *)
broadcast %sqrdmulh 4 [%v4[0]]; smulj %LO %v13 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v13.4s, v13.4s, v3.s[0]                     #! PC = 0x555555550c9c *)
broadcast %mul 4 [%v3[0]]; mul %v13 %v13 %mul;
(* mls	v13.4s, v26.4s, v0.4s                       #! PC = 0x555555550ca0 *)
mull %dc %mls %v26 %v0; sub %v13 %v13 %mls;
(* sqrdmulh	v26.4s, v14.4s, v6.s[0]                #! PC = 0x555555550ca4 *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v14 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v14.4s, v14.4s, v5.s[0]                     #! PC = 0x555555550ca8 *)
broadcast %mul 4 [%v5[0]]; mul %v14 %v14 %mul;
(* mls	v14.4s, v26.4s, v0.4s                       #! PC = 0x555555550cac *)
mull %dc %mls %v26 %v0; sub %v14 %v14 %mls;
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffdfb0; PC = 0x555555550cb4 *)
mov L0x7fffffffdfb0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe030; PC = 0x555555550cbc *)
mov L0x7fffffffe030 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe0b0; PC = 0x555555550cc4 *)
mov L0x7fffffffe0b0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe130; PC = 0x555555550ccc *)
mov L0x7fffffffe130 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe1b0; PC = 0x555555550cd4 *)
mov L0x7fffffffe1b0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe230; PC = 0x555555550cdc *)
...
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd2b0; Value = 0x0000000100000000; PC = 0x555555550cf0 *)
...
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd330; Value = 0x0000002100000020; PC = 0x555555550d00 *)
...
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd3b0; Value = 0x0000004100000040; PC = 0x555555550d10 *)
...
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd430; Value = 0x0000006100000060; PC = 0x555555550d20 *)
...
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd4b0; Value = 0x0000008100000080; PC = 0x555555550d30 *)
...
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd530; Value = 0x000000a1000000a0; PC = 0x555555550d40 *)
...
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd5b0; Value = 0x000000c1000000c0; PC = 0x555555550d50 *)
...
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd630; Value = 0x000000e1000000e0; PC = 0x555555550d60 *)
...
sub %v22 %v10 %v14;
(* add	v7.4s, v15.4s, v19.4s                       #! PC = 0x555555550d84 *)
add %v7 %v15 %v19;
(* sub	v8.4s, v15.4s, v19.4s                       #! PC = 0x555555550d88 *)
sub %v8 %v15 %v19;
(* add	v9.4s, v17.4s, v21.4s                       #! PC = 0x555555550d8c *)
add %v9 %v17 %v21;
(* sub	v10.4s, v17.4s, v21.4s                      #! PC = 0x555555550d90 *)
sub %v10 %v17 %v21;
(* sqrdmulh	v26.4s, v20.4s, v2.s[0]                #! PC = 0x555555550d94 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v20 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v20.4s, v20.4s, v1.s[0]                     #! PC = 0x555555550d98 *)
broadcast %mul 4 [%v1[0]]; mul %v20 %v20 %mul;
(* mls	v20.4s, v26.4s, v0.4s                       #! PC = 0x555555550d9c *)
mull %dc %mls %v26 %v0; sub %v20 %v20 %mls;
(* sqrdmulh	v26.4s, v22.4s, v2.s[0]                #! PC = 0x555555550da0 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v22 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v22.4s, v22.4s, v1.s[0]                     #! PC = 0x555555550da4 *)
broadcast %mul 4 [%v1[0]]; mul %v22 %v22 %mul;
(* mls	v22.4s, v26.4s, v0.4s                       #! PC = 0x555555550da8 *)
mull %dc %mls %v26 %v0; sub %v22 %v22 %mls;
...
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd2b0; PC = 0x555555550dc0 *)
mov L0x7fffffffd2b0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd330; PC = 0x555555550dc8 *)
...
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v10.4s, v10.4s, v1.s[0]                     #! PC = 0x555555550dd0 *)
broadcast %mul 4 [%v1[0]]; mul %v10 %v10 %mul;
(* mls	v10.4s, v26.4s, v0.4s                       #! PC = 0x555555550dd4 *)
mull %dc %mls %v26 %v0; sub %v10 %v10 %mls;
(* sqrdmulh	v26.4s, v13.4s, v4.s[0]                #! PC = 0x555555550dd8 *)
broadcast %sqrdmulh 4 [%v4[0]]; smulj %LO %v13 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v13.4s, v13.4s, v3.s[0]                     #! PC = 0x555555550ddc *)
broadcast %mul 4 [%v3[0]]; mul %v13 %v13 %mul;
(* mls	v13.4s, v26.4s, v0.4s                       #! PC = 0x555555550de0 *)
mull %dc %mls %v26 %v0; sub %v13 %v13 %mls;
(* sqrdmulh	v26.4s, v14.4s, v6.s[0]                #! PC = 0x555555550de4 *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v14 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
(* mul	v14.4s, v14.4s, v5.s[0]                     #! PC = 0x555555550de8 *)
broadcast %mul 4 [%v5[0]]; mul %v14 %v14 %mul;
(* mls	v14.4s, v26.4s, v0.4s                       #! PC = 0x555555550dec *)
mull %dc %mls %v26 %v0; sub %v14 %v14 %mls;
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd3b0; PC = 0x555555550df4 *)
mov L0x7fffffffd3b0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd430; PC = 0x555555550dfc *)
mov L0x7fffffffd430 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd4b0; PC = 0x555555550e04 *)
mov L0x7fffffffd4b0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd530; PC = 0x555555550e0c *)
mov L0x7fffffffd530 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd5b0; PC = 0x555555550e14 *)
mov L0x7fffffffd5b0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd630; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdec0; Value = 0x0000000500000004; PC = 0x555555550bb0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf40; Value = 0x0000002500000024; PC = 0x555555550bc0 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffdfc0; Value = 0x0000004500000044; PC = 0x555555550bd0 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe040; Value = 0x0000006500000064; PC = 0x555555550be0 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe0c0; Value = 0x0000008500000084; PC = 0x555555550bf0 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe140; Value = 0x000000a5000000a4; PC = 0x555555550c00 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe1c0; Value = 0x000000c5000000c4; PC = 0x555555550c10 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe240; Value = 0x000000e5000000e4; PC = 0x555555550c20 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdec0; PC = 0x555555550c80 *)
mov L0x7fffffffdec0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf40; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffdfc0; PC = 0x555555550cb4 *)
mov L0x7fffffffdfc0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe040; PC = 0x555555550cbc *)
mov L0x7fffffffe040 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe0c0; PC = 0x555555550cc4 *)
mov L0x7fffffffe0c0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe140; PC = 0x555555550ccc *)
mov L0x7fffffffe140 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe1c0; PC = 0x555555550cd4 *)
mov L0x7fffffffe1c0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe240; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd2c0; Value = 0x0000000500000004; PC = 0x555555550cf0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd340; Value = 0x0000002500000024; PC = 0x555555550d00 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd3c0; Value = 0x0000004500000044; PC = 0x555555550d10 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd440; Value = 0x0000006500000064; PC = 0x555555550d20 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd4c0; Value = 0x0000008500000084; PC = 0x555555550d30 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd540; Value = 0x000000a5000000a4; PC = 0x555555550d40 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd5c0; Value = 0x000000c5000000c4; PC = 0x555555550d50 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd640; Value = 0x000000e5000000e4; PC = 0x555555550d60 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd2c0; PC = 0x555555550dc0 *)
mov L0x7fffffffd2c0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd340; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd3c0; PC = 0x555555550df4 *)
mov L0x7fffffffd3c0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd440; PC = 0x555555550dfc *)
mov L0x7fffffffd440 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd4c0; PC = 0x555555550e04 *)
mov L0x7fffffffd4c0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd540; PC = 0x555555550e0c *)
mov L0x7fffffffd540 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd5c0; PC = 0x555555550e14 *)
mov L0x7fffffffd5c0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd640; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffded0; Value = 0x0000000900000008; PC = 0x555555550bb0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf50; Value = 0x0000002900000028; PC = 0x555555550bc0 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffdfd0; Value = 0x0000004900000048; PC = 0x555555550bd0 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe050; Value = 0x0000006900000068; PC = 0x555555550be0 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe0d0; Value = 0x0000008900000088; PC = 0x555555550bf0 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe150; Value = 0x000000a9000000a8; PC = 0x555555550c00 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe1d0; Value = 0x000000c9000000c8; PC = 0x555555550c10 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe250; Value = 0x000000e9000000e8; PC = 0x555555550c20 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffded0; PC = 0x555555550c80 *)
mov L0x7fffffffded0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf50; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffdfd0; PC = 0x555555550cb4 *)
mov L0x7fffffffdfd0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe050; PC = 0x555555550cbc *)
mov L0x7fffffffe050 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe0d0; PC = 0x555555550cc4 *)
mov L0x7fffffffe0d0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe150; PC = 0x555555550ccc *)
mov L0x7fffffffe150 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe1d0; PC = 0x555555550cd4 *)
mov L0x7fffffffe1d0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe250; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd2d0; Value = 0x0000000900000008; PC = 0x555555550cf0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd350; Value = 0x0000002900000028; PC = 0x555555550d00 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd3d0; Value = 0x0000004900000048; PC = 0x555555550d10 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd450; Value = 0x0000006900000068; PC = 0x555555550d20 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd4d0; Value = 0x0000008900000088; PC = 0x555555550d30 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd550; Value = 0x000000a9000000a8; PC = 0x555555550d40 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd5d0; Value = 0x000000c9000000c8; PC = 0x555555550d50 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd650; Value = 0x000000e9000000e8; PC = 0x555555550d60 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd2d0; PC = 0x555555550dc0 *)
mov L0x7fffffffd2d0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd350; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd3d0; PC = 0x555555550df4 *)
mov L0x7fffffffd3d0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd450; PC = 0x555555550dfc *)
mov L0x7fffffffd450 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd4d0; PC = 0x555555550e04 *)
mov L0x7fffffffd4d0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd550; PC = 0x555555550e0c *)
mov L0x7fffffffd550 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd5d0; PC = 0x555555550e14 *)
mov L0x7fffffffd5d0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd650; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdee0; Value = 0x0000000d0000000c; PC = 0x555555550bb0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf60; Value = 0x0000002d0000002c; PC = 0x555555550bc0 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffdfe0; Value = 0x0000004d0000004c; PC = 0x555555550bd0 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe060; Value = 0x0000006d0000006c; PC = 0x555555550be0 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe0e0; Value = 0x0000008d0000008c; PC = 0x555555550bf0 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe160; Value = 0x000000ad000000ac; PC = 0x555555550c00 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe1e0; Value = 0x000000cd000000cc; PC = 0x555555550c10 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe260; Value = 0x000000ed000000ec; PC = 0x555555550c20 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdee0; PC = 0x555555550c80 *)
mov L0x7fffffffdee0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf60; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffdfe0; PC = 0x555555550cb4 *)
mov L0x7fffffffdfe0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe060; PC = 0x555555550cbc *)
mov L0x7fffffffe060 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe0e0; PC = 0x555555550cc4 *)
mov L0x7fffffffe0e0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe160; PC = 0x555555550ccc *)
mov L0x7fffffffe160 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe1e0; PC = 0x555555550cd4 *)
mov L0x7fffffffe1e0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe260; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd2e0; Value = 0x0000000d0000000c; PC = 0x555555550cf0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd360; Value = 0x0000002d0000002c; PC = 0x555555550d00 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd3e0; Value = 0x0000004d0000004c; PC = 0x555555550d10 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd460; Value = 0x0000006d0000006c; PC = 0x555555550d20 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd4e0; Value = 0x0000008d0000008c; PC = 0x555555550d30 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd560; Value = 0x000000ad000000ac; PC = 0x555555550d40 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd5e0; Value = 0x000000cd000000cc; PC = 0x555555550d50 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd660; Value = 0x000000ed000000ec; PC = 0x555555550d60 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd2e0; PC = 0x555555550dc0 *)
mov L0x7fffffffd2e0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd360; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd3e0; PC = 0x555555550df4 *)
mov L0x7fffffffd3e0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd460; PC = 0x555555550dfc *)
mov L0x7fffffffd460 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd4e0; PC = 0x555555550e04 *)
mov L0x7fffffffd4e0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd560; PC = 0x555555550e0c *)
mov L0x7fffffffd560 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd5e0; PC = 0x555555550e14 *)
mov L0x7fffffffd5e0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd660; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdef0; Value = 0x0000001100000010; PC = 0x555555550bb0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf70; Value = 0x0000003100000030; PC = 0x555555550bc0 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffdff0; Value = 0x0000005100000050; PC = 0x555555550bd0 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe070; Value = 0x0000007100000070; PC = 0x555555550be0 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe0f0; Value = 0x0000009100000090; PC = 0x555555550bf0 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe170; Value = 0x000000b1000000b0; PC = 0x555555550c00 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe1f0; Value = 0x000000d1000000d0; PC = 0x555555550c10 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe270; Value = 0x000000f1000000f0; PC = 0x555555550c20 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdef0; PC = 0x555555550c80 *)
mov L0x7fffffffdef0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf70; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffdff0; PC = 0x555555550cb4 *)
mov L0x7fffffffdff0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe070; PC = 0x555555550cbc *)
mov L0x7fffffffe070 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe0f0; PC = 0x555555550cc4 *)
mov L0x7fffffffe0f0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe170; PC = 0x555555550ccc *)
mov L0x7fffffffe170 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe1f0; PC = 0x555555550cd4 *)
mov L0x7fffffffe1f0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe270; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd2f0; Value = 0x0000001100000010; PC = 0x555555550cf0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd370; Value = 0x0000003100000030; PC = 0x555555550d00 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd3f0; Value = 0x0000005100000050; PC = 0x555555550d10 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd470; Value = 0x0000007100000070; PC = 0x555555550d20 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd4f0; Value = 0x0000009100000090; PC = 0x555555550d30 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd570; Value = 0x000000b1000000b0; PC = 0x555555550d40 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd5f0; Value = 0x000000d1000000d0; PC = 0x555555550d50 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd670; Value = 0x000000f1000000f0; PC = 0x555555550d60 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd2f0; PC = 0x555555550dc0 *)
mov L0x7fffffffd2f0 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd370; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd3f0; PC = 0x555555550df4 *)
mov L0x7fffffffd3f0 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd470; PC = 0x555555550dfc *)
mov L0x7fffffffd470 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd4f0; PC = 0x555555550e04 *)
mov L0x7fffffffd4f0 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd570; PC = 0x555555550e0c *)
mov L0x7fffffffd570 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd5f0; PC = 0x555555550e14 *)
mov L0x7fffffffd5f0 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd670; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdf00; Value = 0x0000001500000014; PC = 0x555555550bb0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf80; Value = 0x0000003500000034; PC = 0x555555550bc0 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffe000; Value = 0x0000005500000054; PC = 0x555555550bd0 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe080; Value = 0x0000007500000074; PC = 0x555555550be0 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe100; Value = 0x0000009500000094; PC = 0x555555550bf0 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe180; Value = 0x000000b5000000b4; PC = 0x555555550c00 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe200; Value = 0x000000d5000000d4; PC = 0x555555550c10 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe280; Value = 0x000000f5000000f4; PC = 0x555555550c20 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdf00; PC = 0x555555550c80 *)
mov L0x7fffffffdf00 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf80; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffe000; PC = 0x555555550cb4 *)
mov L0x7fffffffe000 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe080; PC = 0x555555550cbc *)
mov L0x7fffffffe080 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe100; PC = 0x555555550cc4 *)
mov L0x7fffffffe100 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe180; PC = 0x555555550ccc *)
mov L0x7fffffffe180 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe200; PC = 0x555555550cd4 *)
mov L0x7fffffffe200 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe280; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd300; Value = 0x0000001500000014; PC = 0x555555550cf0 *)
...
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd380; Value = 0x0000003500000034; PC = 0x555555550d00 *)
...
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd400; Value = 0x0000005500000054; PC = 0x555555550d10 *)
...
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd480; Value = 0x0000007500000074; PC = 0x555555550d20 *)
...
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd500; Value = 0x0000009500000094; PC = 0x555555550d30 *)
...
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd580; Value = 0x000000b5000000b4; PC = 0x555555550d40 *)
...
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd600; Value = 0x000000d5000000d4; PC = 0x555555550d50 *)
...
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd680; Value = 0x000000f5000000f4; PC = 0x555555550d60 *)
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd300; PC = 0x555555550dc0 *)
mov L0x7fffffffd300 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd380; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd400; PC = 0x555555550df4 *)
mov L0x7fffffffd400 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd480; PC = 0x555555550dfc *)
mov L0x7fffffffd480 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd500; PC = 0x555555550e04 *)
mov L0x7fffffffd500 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd580; PC = 0x555555550e0c *)
mov L0x7fffffffd580 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd600; PC = 0x555555550e14 *)
mov L0x7fffffffd600 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd680; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdf10; Value = 0x0000001900000018; PC = 0x555555550bb0 *)
mov v7 L0x7fffffffdf10;
(* add	x8, x4, #0x20                               #! PC = 0x555555550bb4 *)
add x8 x4 0x20@uint64;
(* lsl	x8, x8, #2                                  #! PC = 0x555555550bb8 *)
split dcH x8 x8 (64-2); shl x8 x8 2;
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdf90; Value = 0x0000003900000038; PC = 0x555555550bc0 *)
mov v8 L0x7fffffffdf90;
(* add	x9, x4, #0x40                               #! PC = 0x555555550bc4 *)
add x9 x4 0x40@uint64;
(* lsl	x9, x9, #2                                  #! PC = 0x555555550bc8 *)
split dcH x9 x9 (64-2); shl x9 x9 2;
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffe010; Value = 0x0000005900000058; PC = 0x555555550bd0 *)
mov v9 L0x7fffffffe010;
(* add	x10, x4, #0x60                              #! PC = 0x555555550bd4 *)
add x10 x4 0x60@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550bd8 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe090; Value = 0x0000007900000078; PC = 0x555555550be0 *)
mov v10 L0x7fffffffe090;
(* add	x11, x4, #0x80                              #! PC = 0x555555550be4 *)
add x11 x4 0x80@uint64;
(* lsl	x11, x11, #2                                #! PC = 0x555555550be8 *)
split dcH x11 x11 (64-2); shl x11 x11 2;
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe110; Value = 0x0000009900000098; PC = 0x555555550bf0 *)
mov v11 L0x7fffffffe110;
(* add	x12, x4, #0xa0                              #! PC = 0x555555550bf4 *)
add x12 x4 0xa0@uint64;
(* lsl	x12, x12, #2                                #! PC = 0x555555550bf8 *)
split dcH x12 x12 (64-2); shl x12 x12 2;
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe190; Value = 0x000000b9000000b8; PC = 0x555555550c00 *)
mov v12 L0x7fffffffe190;
(* add	x13, x4, #0xc0                              #! PC = 0x555555550c04 *)
add x13 x4 0xc0@uint64;
(* lsl	x13, x13, #2                                #! PC = 0x555555550c08 *)
split dcH x13 x13 (64-2); shl x13 x13 2;
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe210; Value = 0x000000d9000000d8; PC = 0x555555550c10 *)
mov v13 L0x7fffffffe210;
(* add	x14, x4, #0xe0                              #! PC = 0x555555550c14 *)
add x14 x4 0xe0@uint64;
(* lsl	x14, x14, #2                                #! PC = 0x555555550c18 *)
split dcH x14 x14 (64-2); shl x14 x14 2;
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe290; Value = 0x000000f9000000f8; PC = 0x555555550c20 *)
mov v14 L0x7fffffffe290;
(* add	v15.4s, v7.4s, v11.4s                       #! PC = 0x555555550c24 *)
add %v15 %v7 %v11;
(* sub	v16.4s, v7.4s, v11.4s                       #! PC = 0x555555550c28 *)
sub %v16 %v7 %v11;
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdf10; PC = 0x555555550c80 *)
mov L0x7fffffffdf10 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdf90; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffe010; PC = 0x555555550cb4 *)
mov L0x7fffffffe010 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe090; PC = 0x555555550cbc *)
mov L0x7fffffffe090 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe110; PC = 0x555555550cc4 *)
mov L0x7fffffffe110 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe190; PC = 0x555555550ccc *)
mov L0x7fffffffe190 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe210; PC = 0x555555550cd4 *)
mov L0x7fffffffe210 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe290; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd310; Value = 0x0000001900000018; PC = 0x555555550cf0 *)
mov v7 L0x7fffffffd310;
(* add	x8, x4, #0x20                               #! PC = 0x555555550cf4 *)
add x8 x4 0x20@uint64;
(* lsl	x8, x8, #2                                  #! PC = 0x555555550cf8 *)
split dcH x8 x8 (64-2); shl x8 x8 2;
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd390; Value = 0x0000003900000038; PC = 0x555555550d00 *)
mov v8 L0x7fffffffd390;
(* add	x9, x4, #0x40                               #! PC = 0x555555550d04 *)
add x9 x4 0x40@uint64;
(* lsl	x9, x9, #2                                  #! PC = 0x555555550d08 *)
split dcH x9 x9 (64-2); shl x9 x9 2;
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd410; Value = 0x0000005900000058; PC = 0x555555550d10 *)
mov v9 L0x7fffffffd410;
(* add	x10, x4, #0x60                              #! PC = 0x555555550d14 *)
add x10 x4 0x60@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550d18 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd490; Value = 0x0000007900000078; PC = 0x555555550d20 *)
mov v10 L0x7fffffffd490;
(* add	x11, x4, #0x80                              #! PC = 0x555555550d24 *)
add x11 x4 0x80@uint64;
(* lsl	x11, x11, #2                                #! PC = 0x555555550d28 *)
split dcH x11 x11 (64-2); shl x11 x11 2;
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd510; Value = 0x0000009900000098; PC = 0x555555550d30 *)
mov v11 L0x7fffffffd510;
(* add	x12, x4, #0xa0                              #! PC = 0x555555550d34 *)
add x12 x4 0xa0@uint64;
(* lsl	x12, x12, #2                                #! PC = 0x555555550d38 *)
split dcH x12 x12 (64-2); shl x12 x12 2;
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd590; Value = 0x000000b9000000b8; PC = 0x555555550d40 *)
mov v12 L0x7fffffffd590;
(* add	x13, x4, #0xc0                              #! PC = 0x555555550d44 *)
add x13 x4 0xc0@uint64;
(* lsl	x13, x13, #2                                #! PC = 0x555555550d48 *)
split dcH x13 x13 (64-2); shl x13 x13 2;
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd610; Value = 0x000000d9000000d8; PC = 0x555555550d50 *)
mov v13 L0x7fffffffd610;
(* add	x14, x4, #0xe0                              #! PC = 0x555555550d54 *)
add x14 x4 0xe0@uint64;
(* lsl	x14, x14, #2                                #! PC = 0x555555550d58 *)
split dcH x14 x14 (64-2); shl x14 x14 2;
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd690; Value = 0x000000f9000000f8; PC = 0x555555550d60 *)
mov v14 L0x7fffffffd690;
(* add	v15.4s, v7.4s, v11.4s                       #! PC = 0x555555550d64 *)
add %v15 %v7 %v11;
(* sub	v16.4s, v7.4s, v11.4s                       #! PC = 0x555555550d68 *)
sub %v16 %v7 %v11;
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd310; PC = 0x555555550dc0 *)
mov L0x7fffffffd310 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd390; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd410; PC = 0x555555550df4 *)
mov L0x7fffffffd410 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd490; PC = 0x555555550dfc *)
mov L0x7fffffffd490 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd510; PC = 0x555555550e04 *)
mov L0x7fffffffd510 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd590; PC = 0x555555550e0c *)
mov L0x7fffffffd590 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd610; PC = 0x555555550e14 *)
mov L0x7fffffffd610 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd690; PC = 0x555555550e1c *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550bac *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffdf20; Value = 0x0000001d0000001c; PC = 0x555555550bb0 *)
mov v7 L0x7fffffffdf20;
(* add	x8, x4, #0x20                               #! PC = 0x555555550bb4 *)
add x8 x4 0x20@uint64;
(* lsl	x8, x8, #2                                  #! PC = 0x555555550bb8 *)
split dcH x8 x8 (64-2); shl x8 x8 2;
(* add	x8, x6, x8                                  #! PC = 0x555555550bbc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffdfa0; Value = 0x0000003d0000003c; PC = 0x555555550bc0 *)
mov v8 L0x7fffffffdfa0;
(* add	x9, x4, #0x40                               #! PC = 0x555555550bc4 *)
add x9 x4 0x40@uint64;
(* lsl	x9, x9, #2                                  #! PC = 0x555555550bc8 *)
split dcH x9 x9 (64-2); shl x9 x9 2;
(* add	x9, x6, x9                                  #! PC = 0x555555550bcc *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffe020; Value = 0x0000005d0000005c; PC = 0x555555550bd0 *)
mov v9 L0x7fffffffe020;
(* add	x10, x4, #0x60                              #! PC = 0x555555550bd4 *)
add x10 x4 0x60@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550bd8 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x6, x10                                #! PC = 0x555555550bdc *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffe0a0; Value = 0x0000007d0000007c; PC = 0x555555550be0 *)
mov v10 L0x7fffffffe0a0;
(* add	x11, x4, #0x80                              #! PC = 0x555555550be4 *)
add x11 x4 0x80@uint64;
(* lsl	x11, x11, #2                                #! PC = 0x555555550be8 *)
split dcH x11 x11 (64-2); shl x11 x11 2;
(* add	x11, x6, x11                                #! PC = 0x555555550bec *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffe120; Value = 0x0000009d0000009c; PC = 0x555555550bf0 *)
mov v11 L0x7fffffffe120;
(* add	x12, x4, #0xa0                              #! PC = 0x555555550bf4 *)
add x12 x4 0xa0@uint64;
(* lsl	x12, x12, #2                                #! PC = 0x555555550bf8 *)
split dcH x12 x12 (64-2); shl x12 x12 2;
(* add	x12, x6, x12                                #! PC = 0x555555550bfc *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffe1a0; Value = 0x000000bd000000bc; PC = 0x555555550c00 *)
mov v12 L0x7fffffffe1a0;
(* add	x13, x4, #0xc0                              #! PC = 0x555555550c04 *)
add x13 x4 0xc0@uint64;
(* lsl	x13, x13, #2                                #! PC = 0x555555550c08 *)
split dcH x13 x13 (64-2); shl x13 x13 2;
(* add	x13, x6, x13                                #! PC = 0x555555550c0c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffe220; Value = 0x000000dd000000dc; PC = 0x555555550c10 *)
mov v13 L0x7fffffffe220;
(* add	x14, x4, #0xe0                              #! PC = 0x555555550c14 *)
add x14 x4 0xe0@uint64;
(* lsl	x14, x14, #2                                #! PC = 0x555555550c18 *)
split dcH x14 x14 (64-2); shl x14 x14 2;
(* add	x14, x6, x14                                #! PC = 0x555555550c1c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffe2a0; Value = 0x000000fd000000fc; PC = 0x555555550c20 *)
mov v14 L0x7fffffffe2a0;
(* add	v15.4s, v7.4s, v11.4s                       #! PC = 0x555555550c24 *)
add %v15 %v7 %v11;
(* sub	v16.4s, v7.4s, v11.4s                       #! PC = 0x555555550c28 *)
sub %v16 %v7 %v11;
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c7c *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffdf20; PC = 0x555555550c80 *)
mov L0x7fffffffdf20 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550c84 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffdfa0; PC = 0x555555550c88 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffe020; PC = 0x555555550cb4 *)
mov L0x7fffffffe020 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550cb8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffe0a0; PC = 0x555555550cbc *)
mov L0x7fffffffe0a0 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc0 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffe120; PC = 0x555555550cc4 *)
mov L0x7fffffffe120 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550cc8 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffe1a0; PC = 0x555555550ccc *)
mov L0x7fffffffe1a0 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd0 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffe220; PC = 0x555555550cd4 *)
mov L0x7fffffffe220 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550cd8 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffe2a0; PC = 0x555555550cdc *)
...
(* add	x7, x6, x7                                  #! PC = 0x555555550cec *)
add x7 x6 x7;
(* ldr	q7, [x7]                                    #! EA = L0x7fffffffd320; Value = 0x0000001d0000001c; PC = 0x555555550cf0 *)
mov v7 L0x7fffffffd320;
(* add	x8, x4, #0x20                               #! PC = 0x555555550cf4 *)
add x8 x4 0x20@uint64;
(* lsl	x8, x8, #2                                  #! PC = 0x555555550cf8 *)
split dcH x8 x8 (64-2); shl x8 x8 2;
(* add	x8, x6, x8                                  #! PC = 0x555555550cfc *)
add x8 x6 x8;
(* ldr	q8, [x8]                                    #! EA = L0x7fffffffd3a0; Value = 0x0000003d0000003c; PC = 0x555555550d00 *)
mov v8 L0x7fffffffd3a0;
(* add	x9, x4, #0x40                               #! PC = 0x555555550d04 *)
add x9 x4 0x40@uint64;
(* lsl	x9, x9, #2                                  #! PC = 0x555555550d08 *)
split dcH x9 x9 (64-2); shl x9 x9 2;
(* add	x9, x6, x9                                  #! PC = 0x555555550d0c *)
add x9 x6 x9;
(* ldr	q9, [x9]                                    #! EA = L0x7fffffffd420; Value = 0x0000005d0000005c; PC = 0x555555550d10 *)
mov v9 L0x7fffffffd420;
(* add	x10, x4, #0x60                              #! PC = 0x555555550d14 *)
add x10 x4 0x60@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550d18 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x6, x10                                #! PC = 0x555555550d1c *)
add x10 x6 x10;
(* ldr	q10, [x10]                                  #! EA = L0x7fffffffd4a0; Value = 0x0000007d0000007c; PC = 0x555555550d20 *)
mov v10 L0x7fffffffd4a0;
(* add	x11, x4, #0x80                              #! PC = 0x555555550d24 *)
add x11 x4 0x80@uint64;
(* lsl	x11, x11, #2                                #! PC = 0x555555550d28 *)
split dcH x11 x11 (64-2); shl x11 x11 2;
(* add	x11, x6, x11                                #! PC = 0x555555550d2c *)
add x11 x6 x11;
(* ldr	q11, [x11]                                  #! EA = L0x7fffffffd520; Value = 0x0000009d0000009c; PC = 0x555555550d30 *)
mov v11 L0x7fffffffd520;
(* add	x12, x4, #0xa0                              #! PC = 0x555555550d34 *)
add x12 x4 0xa0@uint64;
(* lsl	x12, x12, #2                                #! PC = 0x555555550d38 *)
split dcH x12 x12 (64-2); shl x12 x12 2;
(* add	x12, x6, x12                                #! PC = 0x555555550d3c *)
add x12 x6 x12;
(* ldr	q12, [x12]                                  #! EA = L0x7fffffffd5a0; Value = 0x000000bd000000bc; PC = 0x555555550d40 *)
mov v12 L0x7fffffffd5a0;
(* add	x13, x4, #0xc0                              #! PC = 0x555555550d44 *)
add x13 x4 0xc0@uint64;
(* lsl	x13, x13, #2                                #! PC = 0x555555550d48 *)
split dcH x13 x13 (64-2); shl x13 x13 2;
(* add	x13, x6, x13                                #! PC = 0x555555550d4c *)
add x13 x6 x13;
(* ldr	q13, [x13]                                  #! EA = L0x7fffffffd620; Value = 0x000000dd000000dc; PC = 0x555555550d50 *)
mov v13 L0x7fffffffd620;
(* add	x14, x4, #0xe0                              #! PC = 0x555555550d54 *)
add x14 x4 0xe0@uint64;
(* lsl	x14, x14, #2                                #! PC = 0x555555550d58 *)
split dcH x14 x14 (64-2); shl x14 x14 2;
(* add	x14, x6, x14                                #! PC = 0x555555550d5c *)
add x14 x6 x14;
(* ldr	q14, [x14]                                  #! EA = L0x7fffffffd6a0; Value = 0x000000fd000000fc; PC = 0x555555550d60 *)
mov v14 L0x7fffffffd6a0;
(* add	v15.4s, v7.4s, v11.4s                       #! PC = 0x555555550d64 *)
add %v15 %v7 %v11;
(* sub	v16.4s, v7.4s, v11.4s                       #! PC = 0x555555550d68 *)
sub %v16 %v7 %v11;
...
(* add	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dbc *)
add %v25 %v7 %v9;
(* str	q25, [x7]                                   #! EA = L0x7fffffffd320; PC = 0x555555550dc0 *)
mov L0x7fffffffd320 v25;
(* sub	v25.4s, v7.4s, v9.4s                        #! PC = 0x555555550dc4 *)
sub %v25 %v7 %v9;
(* str	q25, [x8]                                   #! EA = L0x7fffffffd3a0; PC = 0x555555550dc8 *)
...
(* add	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df0 *)
add %v25 %v8 %v10;
(* str	q25, [x9]                                   #! EA = L0x7fffffffd420; PC = 0x555555550df4 *)
mov L0x7fffffffd420 v25;
(* sub	v25.4s, v8.4s, v10.4s                       #! PC = 0x555555550df8 *)
sub %v25 %v8 %v10;
(* str	q25, [x10]                                  #! EA = L0x7fffffffd4a0; PC = 0x555555550dfc *)
mov L0x7fffffffd4a0 v25;
(* add	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e00 *)
add %v25 %v11 %v13;
(* str	q25, [x11]                                  #! EA = L0x7fffffffd520; PC = 0x555555550e04 *)
mov L0x7fffffffd520 v25;
(* sub	v25.4s, v11.4s, v13.4s                      #! PC = 0x555555550e08 *)
sub %v25 %v11 %v13;
(* str	q25, [x12]                                  #! EA = L0x7fffffffd5a0; PC = 0x555555550e0c *)
mov L0x7fffffffd5a0 v25;
(* add	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e10 *)
add %v25 %v12 %v14;
(* str	q25, [x13]                                  #! EA = L0x7fffffffd620; PC = 0x555555550e14 *)
mov L0x7fffffffd620 v25;
(* sub	v25.4s, v12.4s, v14.4s                      #! PC = 0x555555550e18 *)
sub %v25 %v12 %v14;
(* str	q25, [x14]                                  #! EA = L0x7fffffffd6a0; PC = 0x555555550e1c *)
...
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffdeb0; Value = 0x0000038800000380 0x0000039800000390; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x0000038800000380 0x0000039800000390 = 0x0000038800000380 0x0000039800000390; 0x555555550ed4 = 0x555555550ed4;
...
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdef0; Value = 0x0000040800000400 0x0000041800000410; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdef0                      #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x0000040800000400 0x0000041800000410 = 0x0000040800000400 0x0000041800000410; 0x555555550ee4 = 0x555555550ee4;
...
(* add	v15.4s, v23.4s, v25.4s                      #! PC = 0x555555550f50 *)
add %v15 %v23 %v25;
(* sub	v16.4s, v23.4s, v25.4s                      #! PC = 0x555555550f54 *)
sub %v16 %v23 %v25;
(* add	v17.4s, v24.4s, v26.4s                      #! PC = 0x555555550f58 *)
add %v17 %v24 %v26;
(* sub	v18.4s, v24.4s, v26.4s                      #! PC = 0x555555550f5c *)
sub %v18 %v24 %v26;
(* sqrdmulh	v27.4s, v21.4s, v6.s[0]                #! PC = 0x555555550f60 *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v21 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
(* mul	v21.4s, v21.4s, v5.s[0]                     #! PC = 0x555555550f64 *)
broadcast %mul 4 [%v5[0]]; mul %v21 %v21 %mul;
(* mls	v21.4s, v27.4s, v0.4s                       #! PC = 0x555555550f68 *)
mull %dc %mls %v27 %v0; sub %v21 %v21 %mls;
(* sqrdmulh	v27.4s, v22.4s, v6.s[0]                #! PC = 0x555555550f6c *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v22 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
(* mul	v22.4s, v22.4s, v5.s[0]                     #! PC = 0x555555550f70 *)
broadcast %mul 4 [%v5[0]]; mul %v22 %v22 %mul;
(* mls	v22.4s, v27.4s, v0.4s                       #! PC = 0x555555550f74 *)
mull %dc %mls %v27 %v0; sub %v22 %v22 %mls;
...
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffdeb0; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
(* add	v21.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd4 *)
add %v21 %v24 %v26;
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdef0; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdef0                      #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x555555550fdc = 0x555555550fdc;
...
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd2b0; Value = 0x0000038800000380 0x0000039800000390; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd2b0                       #! L0x7fffffffd2b0 = L0x7fffffffd2b0; 0x0000038800000380 0x0000039800000390 = 0x0000038800000380 0x0000039800000390; 0x555555550fec = 0x555555550fec;
...
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd2f0; Value = 0x0000040800000400 0x0000041800000410; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd2f0                      #! L0x7fffffffd2f0 = L0x7fffffffd2f0; 0x0000040800000400 0x0000041800000410 = 0x0000040800000400 0x0000041800000410; 0x555555550ffc = 0x555555550ffc;
...
mull %dc %mls %v27 %v0; sub %v26 %v26 %mls;
(* add	v15.4s, v23.4s, v25.4s                      #! PC = 0x555555551068 *)
add %v15 %v23 %v25;
(* sub	v16.4s, v23.4s, v25.4s                      #! PC = 0x55555555106c *)
sub %v16 %v23 %v25;
(* add	v17.4s, v24.4s, v26.4s                      #! PC = 0x555555551070 *)
add %v17 %v24 %v26;
(* sub	v18.4s, v24.4s, v26.4s                      #! PC = 0x555555551074 *)
sub %v18 %v24 %v26;
(* sqrdmulh	v27.4s, v21.4s, v6.s[0]                #! PC = 0x555555551078 *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v21 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
(* mul	v21.4s, v21.4s, v5.s[0]                     #! PC = 0x55555555107c *)
broadcast %mul 4 [%v5[0]]; mul %v21 %v21 %mul;
(* mls	v21.4s, v27.4s, v0.4s                       #! PC = 0x555555551080 *)
mull %dc %mls %v27 %v0; sub %v21 %v21 %mls;
(* sqrdmulh	v27.4s, v22.4s, v6.s[0]                #! PC = 0x555555551084 *)
broadcast %sqrdmulh 4 [%v6[0]]; smulj %LO %v22 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
(* mul	v22.4s, v22.4s, v5.s[0]                     #! PC = 0x555555551088 *)
broadcast %mul 4 [%v5[0]]; mul %v22 %v22 %mul;
(* mls	v22.4s, v27.4s, v0.4s                       #! PC = 0x55555555108c *)
mull %dc %mls %v27 %v0; sub %v22 %v22 %mls;
...
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd2b0; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd2b0                       #! L0x7fffffffd2b0 = L0x7fffffffd2b0; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
(* add	v21.4s, v24.4s, v26.4s                      #! PC = 0x5555555510ec *)
add %v21 %v24 %v26;
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd2f0; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd2f0                      #! L0x7fffffffd2f0 = L0x7fffffffd2f0; 0x5555555510f4 = 0x5555555510f4;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffdf30; Value = 0xffffff80ffffff80 0xffffff80ffffff80; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0xffffff80ffffff80 0xffffff80ffffff80 = 0xffffff80ffffff80 0xffffff80ffffff80; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdf70; Value = 0xffffff80ffffff80 0xffffff80ffffff80; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdf70                      #! L0x7fffffffdf70 = L0x7fffffffdf70; 0xffffff80ffffff80 0xffffff80ffffff80 = 0xffffff80ffffff80 0xffffff80ffffff80; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffdf30; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdf70; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdf70                      #! L0x7fffffffdf70 = L0x7fffffffdf70; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd330; Value = 0xffffff80ffffff80 0xffffff80ffffff80; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd330                       #! L0x7fffffffd330 = L0x7fffffffd330; 0xffffff80ffffff80 0xffffff80ffffff80 = 0xffffff80ffffff80 0xffffff80ffffff80; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd370; Value = 0xffffff80ffffff80 0xffffff80ffffff80; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd370                      #! L0x7fffffffd370 = L0x7fffffffd370; 0xffffff80ffffff80 0xffffff80ffffff80 = 0xffffff80ffffff80 0xffffff80ffffff80; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd330; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd330                       #! L0x7fffffffd330 = L0x7fffffffd330; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd370; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd370                      #! L0x7fffffffd370 = L0x7fffffffd370; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffdfb0; Value = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28 = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdff0; Value = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdff0                      #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28 = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffdfb0; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffdff0; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdff0                      #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd3b0; Value = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd3b0                       #! L0x7fffffffd3b0 = L0x7fffffffd3b0; 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28 = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd3f0; Value = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd3f0                      #! L0x7fffffffd3f0 = L0x7fffffffd3f0; 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28 = 0x02bcdc2802bcdc28 0x02bcdc2802bcdc28; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd3b0; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd3b0                       #! L0x7fffffffd3b0 = L0x7fffffffd3b0; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd3f0; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd3f0                      #! L0x7fffffffd3f0 = L0x7fffffffd3f0; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffe030; Value = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8 = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe070; Value = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe070                      #! L0x7fffffffe070 = L0x7fffffffe070; 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8 = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffe030; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe070; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe070                      #! L0x7fffffffe070 = L0x7fffffffe070; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd430; Value = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd430                       #! L0x7fffffffd430 = L0x7fffffffd430; 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8 = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd470; Value = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd470                      #! L0x7fffffffd470 = L0x7fffffffd470; 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8 = 0xfd4322d8fd4322d8 0xfd4322d8fd4322d8; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd430; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd430                       #! L0x7fffffffd430 = L0x7fffffffd430; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd470; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd470                      #! L0x7fffffffd470 = L0x7fffffffd470; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffe0b0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe0f0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe0f0                      #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffe0b0; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe0f0; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe0f0                      #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd4b0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd4b0                       #! L0x7fffffffd4b0 = L0x7fffffffd4b0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd4f0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd4f0                      #! L0x7fffffffd4f0 = L0x7fffffffd4f0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd4b0; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd4b0                       #! L0x7fffffffd4b0 = L0x7fffffffd4b0; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd4f0; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd4f0                      #! L0x7fffffffd4f0 = L0x7fffffffd4f0; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffe130; Value = 0x0486412304864123 0x0486412304864123; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x0486412304864123 0x0486412304864123 = 0x0486412304864123 0x0486412304864123; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe170; Value = 0x0486412304864123 0x0486412304864123; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe170                      #! L0x7fffffffe170 = L0x7fffffffe170; 0x0486412304864123 0x0486412304864123 = 0x0486412304864123 0x0486412304864123; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffe130; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe170; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe170                      #! L0x7fffffffe170 = L0x7fffffffe170; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd530; Value = 0x0486412304864123 0x0486412304864123; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd530                       #! L0x7fffffffd530 = L0x7fffffffd530; 0x0486412304864123 0x0486412304864123 = 0x0486412304864123 0x0486412304864123; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd570; Value = 0x0486412304864123 0x0486412304864123; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd570                      #! L0x7fffffffd570 = L0x7fffffffd570; 0x0486412304864123 0x0486412304864123 = 0x0486412304864123 0x0486412304864123; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd530; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd530                       #! L0x7fffffffd530 = L0x7fffffffd530; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd570; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd570                      #! L0x7fffffffd570 = L0x7fffffffd570; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffe1b0; Value = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe1f0; Value = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe1f0                      #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffe1b0; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe1f0; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe1f0                      #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd5b0; Value = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd5b0                       #! L0x7fffffffd5b0 = L0x7fffffffd5b0; 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd5f0; Value = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd5f0                      #! L0x7fffffffd5f0 = L0x7fffffffd5f0; 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd = 0xfb79bdddfb79bddd 0xfb79bdddfb79bddd; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd5b0; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd5b0                       #! L0x7fffffffd5b0 = L0x7fffffffd5b0; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd5f0; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd5f0                      #! L0x7fffffffd5f0 = L0x7fffffffd5f0; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
(* add	x9, x9, x8                                  #! PC = 0x555555550ed0 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffe230; Value = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; PC = 0x555555550ed4 *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3 = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; 0x555555550ed4 = 0x555555550ed4;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ed8 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550edc *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ee0 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe270; Value = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; PC = 0x555555550ee4 *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe270                      #! L0x7fffffffe270 = L0x7fffffffe270; 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3 = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; 0x555555550ee4 = 0x555555550ee4;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555550ee8 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x555555550fc4 *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffe230; PC = 0x555555550fc8 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0x555555550fc8 = 0x555555550fc8;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x555555550fcc *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x555555550fd0 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x555555550fd8 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffe270; PC = 0x555555550fdc *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe270                      #! L0x7fffffffe270 = L0x7fffffffe270; 0x555555550fdc = 0x555555550fdc;
(* add	x8, x1, #0x0                                #! PC = 0x555555550fe0 *)
add x8 x1 0x0@uint64;
(* lsl	x9, x4, #2                                  #! PC = 0x555555550fe4 *)
split dcH x9 x4 (64-2); shl x9 x9 2;
(* add	x9, x9, x8                                  #! PC = 0x555555550fe8 *)
add x9 x9 x8;
(* ld1	{v15.4s-v18.4s}, [x9]                       #! EA = L0x7fffffffd630; Value = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; PC = 0x555555550fec *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffd630                       #! L0x7fffffffd630 = L0x7fffffffd630; 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3 = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; 0x555555550fec = 0x555555550fec;
(* add	x10, x4, #0x10                              #! PC = 0x555555550ff0 *)
add x10 x4 0x10@uint64;
(* lsl	x10, x10, #2                                #! PC = 0x555555550ff4 *)
split dcH x10 x10 (64-2); shl x10 x10 2;
(* add	x10, x10, x8                                #! PC = 0x555555550ff8 *)
add x10 x10 x8;
(* ld1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd670; Value = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; PC = 0x555555550ffc *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd670                      #! L0x7fffffffd670 = L0x7fffffffd670; 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3 = 0xff0c87d3ff0c87d3 0xff0c87d3ff0c87d3; 0x555555550ffc = 0x555555550ffc;
(* sqrdmulh	v27.4s, v19.4s, v2.s[0]                #! PC = 0x555555551000 *)
broadcast %sqrdmulh 4 [%v2[0]]; smulj %LO %v19 %sqrdmulh;
ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
...
(* sub	v22.4s, v16.4s, v18.4s                      #! PC = 0x5555555510dc *)
sub %v22 %v16 %v18;
(* st1	{v19.4s-v22.4s}, [x9]                       #! EA = L0x7fffffffd630; PC = 0x5555555510e0 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd630                       #! L0x7fffffffd630 = L0x7fffffffd630; 0x5555555510e0 = 0x5555555510e0;
(* add	v19.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e4 *)
add %v19 %v23 %v25;
(* sub	v20.4s, v23.4s, v25.4s                      #! PC = 0x5555555510e8 *)
sub %v20 %v23 %v25;
...
(* sub	v22.4s, v24.4s, v26.4s                      #! PC = 0x5555555510f0 *)
sub %v22 %v24 %v26;
(* st1	{v19.4s-v22.4s}, [x10]                      #! EA = L0x7fffffffd670; PC = 0x5555555510f4 *)
st1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffd670                      #! L0x7fffffffd670 = L0x7fffffffd670; 0x5555555510f4 = 0x5555555510f4;
(* add	x4, x4, #0x20                               #! PC = 0x5555555510f8 *)
add x4 x4 0x20@uint64;
(* #b	0x555555550e2c <p1stage2LoopStart>           #! PC = 0x5555555510fc *)
#b	0x555555550e2c <p1stage2LoopStart>           #! 0x5555555510fc = 0x5555555510fc;
...
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdeb0; Value = 0x00001fc000001f80 0x0000204000002000; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x00001fc000001f80 0x0000204000002000 = 0x00001fc000001f80 0x0000204000002000; 0x555555551144 = 0x555555551144;
...
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd2b0; Value = 0x00001fc000001f80 0x0000204000002000; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd2b0                       #! L0x7fffffffd2b0 = L0x7fffffffd2b0; 0x00001fc000001f80 0x0000204000002000 = 0x00001fc000001f80 0x0000204000002000; 0x5555555511d4 = 0x5555555511d4;
...
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdeb0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x5555555512a4 = 0x5555555512a4;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdef0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdef0                       #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd2f0; Value = 0x00f3772d00f3772d 0x00f3772d00f3772d; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd2f0                       #! L0x7fffffffd2f0 = L0x7fffffffd2f0; 0x00f3772d00f3772d 0x00f3772d00f3772d = 0x00f3772d00f3772d 0x00f3772d00f3772d; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdef0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdef0                       #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdf30; Value = 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7 = 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd330; Value = 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd330                       #! L0x7fffffffd330 = L0x7fffffffd330; 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7 = 0x03ac0ce703ac0ce7 0x03ac0ce703ac0ce7; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdf30; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdf70; Value = 0xfa586a8afa586a8a 0xfa586a8afa586a8a; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdf70                       #! L0x7fffffffdf70 = L0x7fffffffdf70; 0xfa586a8afa586a8a 0xfa586a8afa586a8a = 0xfa586a8afa586a8a 0xfa586a8afa586a8a; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd370; Value = 0xfa586a8afa586a8a 0xfa586a8afa586a8a; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd370                       #! L0x7fffffffd370 = L0x7fffffffd370; 0xfa586a8afa586a8a 0xfa586a8afa586a8a = 0xfa586a8afa586a8a 0xfa586a8afa586a8a; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdf70; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdf70                       #! L0x7fffffffdf70 = L0x7fffffffdf70; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdfb0; Value = 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c = 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd3b0; Value = 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd3b0                       #! L0x7fffffffd3b0 = L0x7fffffffd3b0; 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c = 0x007f3f0c007f3f0c 0x007f3f0c007f3f0c; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdfb0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdff0; Value = 0x037ef2de037ef2de 0x037ef2de037ef2de; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdff0                       #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x037ef2de037ef2de 0x037ef2de037ef2de = 0x037ef2de037ef2de 0x037ef2de037ef2de; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd3f0; Value = 0x037ef2de037ef2de 0x037ef2de037ef2de; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd3f0                       #! L0x7fffffffd3f0 = L0x7fffffffd3f0; 0x037ef2de037ef2de 0x037ef2de037ef2de = 0x037ef2de037ef2de 0x037ef2de037ef2de; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffdff0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffdff0                       #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe030; Value = 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04 = 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd430; Value = 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd430                       #! L0x7fffffffd430 = L0x7fffffffd430; 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04 = 0xfc9b7e04fc9b7e04 0xfc9b7e04fc9b7e04; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe030; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe070; Value = 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe070                       #! L0x7fffffffe070 = L0x7fffffffe070; 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c = 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd470; Value = 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd470                       #! L0x7fffffffd470 = L0x7fffffffd470; 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c = 0xfe84f04cfe84f04c 0xfe84f04cfe84f04c; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe070; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe070                       #! L0x7fffffffe070 = L0x7fffffffe070; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe0b0; Value = 0xfe420afafe420afa 0xfe420afafe420afa; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0xfe420afafe420afa 0xfe420afafe420afa = 0xfe420afafe420afa 0xfe420afafe420afa; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd4b0; Value = 0xfe420afafe420afa 0xfe420afafe420afa; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd4b0                       #! L0x7fffffffd4b0 = L0x7fffffffd4b0; 0xfe420afafe420afa 0xfe420afafe420afa = 0xfe420afafe420afa 0xfe420afafe420afa; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe0b0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe0f0; Value = 0xfb297370fb297370 0xfb297370fb297370; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe0f0                       #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0xfb297370fb297370 0xfb297370fb297370 = 0xfb297370fb297370 0xfb297370fb297370; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd4f0; Value = 0xfb297370fb297370 0xfb297370fb297370; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd4f0                       #! L0x7fffffffd4f0 = L0x7fffffffd4f0; 0xfb297370fb297370 0xfb297370fb297370 = 0xfb297370fb297370 0xfb297370fb297370; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe0f0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe0f0                       #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe130; Value = 0x00a42bae00a42bae 0x00a42bae00a42bae; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x00a42bae00a42bae 0x00a42bae00a42bae = 0x00a42bae00a42bae 0x00a42bae00a42bae; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd530; Value = 0x00a42bae00a42bae 0x00a42bae00a42bae; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd530                       #! L0x7fffffffd530 = L0x7fffffffd530; 0x00a42bae00a42bae 0x00a42bae00a42bae = 0x00a42bae00a42bae 0x00a42bae00a42bae; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe130; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe170; Value = 0x0604eef50604eef5 0x0604eef50604eef5; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe170                       #! L0x7fffffffe170 = L0x7fffffffe170; 0x0604eef50604eef5 0x0604eef50604eef5 = 0x0604eef50604eef5 0x0604eef50604eef5; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd570; Value = 0x0604eef50604eef5 0x0604eef50604eef5; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd570                       #! L0x7fffffffd570 = L0x7fffffffd570; 0x0604eef50604eef5 0x0604eef50604eef5 = 0x0604eef50604eef5 0x0604eef50604eef5; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe170; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe170                       #! L0x7fffffffe170 = L0x7fffffffe170; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe1b0; Value = 0xfde98c71fde98c71 0xfde98c71fde98c71; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0xfde98c71fde98c71 0xfde98c71fde98c71 = 0xfde98c71fde98c71 0xfde98c71fde98c71; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd5b0; Value = 0xfde98c71fde98c71 0xfde98c71fde98c71; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd5b0                       #! L0x7fffffffd5b0 = L0x7fffffffd5b0; 0xfde98c71fde98c71 0xfde98c71fde98c71 = 0xfde98c71fde98c71 0xfde98c71fde98c71; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe1b0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe1f0; Value = 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe1f0                       #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3 = 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd5f0; Value = 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd5f0                       #! L0x7fffffffd5f0 = L0x7fffffffd5f0; 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3 = 0x000d2dd3000d2dd3 0x000d2dd3000d2dd3; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe1f0; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe1f0                       #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe230; Value = 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f = 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd630; Value = 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd630                       #! L0x7fffffffd630 = L0x7fffffffd630; 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f = 0xfe58be8ffe58be8f 0xfe58be8ffe58be8f; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe230; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
(* add	x7, x7, x5                                  #! PC = 0x555555551140 *)
add x7 x7 x5;
(* ld4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe270; Value = 0xfc584355fc584355 0xfc584355fc584355; PC = 0x555555551144 *)
ld4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe270                       #! L0x7fffffffe270 = L0x7fffffffe270; 0xfc584355fc584355 0xfc584355fc584355 = 0xfc584355fc584355 0xfc584355fc584355; 0x555555551144 = 0x555555551144;
(* lsr	x9, x4, #2                                  #! PC = 0x555555551148 *)
split x9 dcL x4 2;
(* lsl	x10, x9, #2                                 #! PC = 0x55555555114c *)
split dcH x10 x9 (64-2); shl x10 x10 2;
...
(* add	x8, x8, x6                                  #! PC = 0x5555555511d0 *)
add x8 x8 x6;
(* ld4	{v14.4s-v17.4s}, [x8]                       #! EA = L0x7fffffffd670; Value = 0xfc584355fc584355 0xfc584355fc584355; PC = 0x5555555511d4 *)
ld4	{%%v14.4s-%%v17.4s}, %%L0x7fffffffd670                       #! L0x7fffffffd670 = L0x7fffffffd670; 0xfc584355fc584355 0xfc584355fc584355 = 0xfc584355fc584355 0xfc584355fc584355; 0x5555555511d4 = 0x5555555511d4;
(* sqrdmulh	v23.4s, v16.4s, v4.4s                  #! PC = 0x5555555511d8 *)
smulj %LO %v16 %v4; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v23 %LO11 %LO01;
...
(* sub	v13.4s, v15.4s, v17.4s                      #! PC = 0x5555555512a0 *)
sub %v13 %v15 %v17;
(* st4	{v10.4s-v13.4s}, [x7]                       #! EA = L0x7fffffffe270; PC = 0x5555555512a4 *)
st4	{%%v10.4s-%%v13.4s}, %%L0x7fffffffe270                       #! L0x7fffffffe270 = L0x7fffffffe270; 0x5555555512a4 = 0x5555555512a4;
(* add	x4, x4, #0x10                               #! PC = 0x5555555512a8 *)
add x4 x4 0x10@uint64;
(* #b	0x555555551130 <p1stage3LoopStart>           #! PC = 0x5555555512ac *)
#b	0x555555551130 <p1stage3LoopStart>           #! 0x5555555512ac = 0x5555555512ac;
...
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffdeb0; Value = 0x05b0d55dffe03a2c 0xfe4f569bffe03a2c; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x05b0d55dffe03a2c 0xfe4f569bffe03a2c = 0x05b0d55dffe03a2c 0xfe4f569bffe03a2c; 0x55555555131c = 0x55555555131c;
...
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffdef0; Value = 0x05f0fb08038dc88b 0xfecbc66c01e60599; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdef0                       #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x05f0fb08038dc88b 0xfecbc66c01e60599 = 0x05f0fb08038dc88b 0xfecbc66c01e60599; 0x55555555132c = 0x55555555132c;
...
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffdeb0; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdeb0                       #! L0x7fffffffdeb0 = L0x7fffffffdeb0; 0x555555551410 = 0x555555551410;
...
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffdef0; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdef0                       #! L0x7fffffffdef0 = L0x7fffffffdef0; 0x555555551424 = 0x555555551424;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffdf30; Value = 0x0048a154047eaa5c 0x00a4343a085bcd4a; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0x0048a154047eaa5c 0x00a4343a085bcd4a = 0x0048a154047eaa5c 0x00a4343a085bcd4a; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffdf70; Value = 0x031bea4ef8f0932f 0xfbe0552800edd3c3; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdf70                       #! L0x7fffffffdf70 = L0x7fffffffdf70; 0x031bea4ef8f0932f 0xfbe0552800edd3c3 = 0x031bea4ef8f0932f 0xfbe0552800edd3c3; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffdf30; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdf30                       #! L0x7fffffffdf30 = L0x7fffffffdf30; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffdf70; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdf70                       #! L0x7fffffffdf70 = L0x7fffffffdf70; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffdfb0; Value = 0xfb32161bfa5ce2bf 0x00da125d052de9b5; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0xfb32161bfa5ce2bf 0x00da125d052de9b5 = 0xfb32161bfa5ce2bf 0x00da125d052de9b5; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffdff0; Value = 0x02595d6d045c9eac 0x01e26af106f6bf6a; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffdff0                       #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x02595d6d045c9eac 0x01e26af106f6bf6a = 0x02595d6d045c9eac 0x01e26af106f6bf6a; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffdfb0; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdfb0                       #! L0x7fffffffdfb0 = L0x7fffffffdfb0; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffdff0; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffdff0                       #! L0x7fffffffdff0 = L0x7fffffffdff0; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffe030; Value = 0x024abf7c022c4e38 0xfafecc880125d9cc; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0x024abf7c022c4e38 0xfafecc880125d9cc = 0x024abf7c022c4e38 0xfafecc880125d9cc; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffe070; Value = 0x03055d9e02c282ce 0xffeddee804f0c3e4; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe070                       #! L0x7fffffffe070 = L0x7fffffffe070; 0x03055d9e02c282ce 0xffeddee804f0c3e4 = 0x03055d9e02c282ce 0xffeddee804f0c3e4; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffe030; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe030                       #! L0x7fffffffe030 = L0x7fffffffe030; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffe070; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe070                       #! L0x7fffffffe070 = L0x7fffffffe070; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffe0b0; Value = 0xff4bea4b02d3a6f8 0xff43c2d1020958f0; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0xff4bea4b02d3a6f8 0xff43c2d1020958f0 = 0xff4bea4b02d3a6f8 0xff43c2d1020958f0; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffe0f0; Value = 0xfd164148fdf4ad56 0x049d583202c7a848; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe0f0                       #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0xfd164148fdf4ad56 0x049d583202c7a848 = 0xfd164148fdf4ad56 0x049d583202c7a848; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffe0b0; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe0b0                       #! L0x7fffffffe0b0 = L0x7fffffffe0b0; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffe0f0; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe0f0                       #! L0x7fffffffe0f0 = L0x7fffffffe0f0; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffe130; Value = 0x041cfb9efe4d2bde 0x05b4892cff468140; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x041cfb9efe4d2bde 0x05b4892cff468140 = 0x041cfb9efe4d2bde 0x05b4892cff468140; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffe170; Value = 0xffe35b5cfa512a78 0xfa639d1cffdbd480; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe170                       #! L0x7fffffffe170 = L0x7fffffffe170; 0xffe35b5cfa512a78 0xfa639d1cffdbd480 = 0xffe35b5cfa512a78 0xfa639d1cffdbd480; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffe130; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe130                       #! L0x7fffffffe130 = L0x7fffffffe130; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffe170; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe170                       #! L0x7fffffffe170 = L0x7fffffffe170; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffe1b0; Value = 0x02e78890006fc639 0xfcdc3cb6086d5a19; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0x02e78890006fc639 0xfcdc3cb6086d5a19 = 0x02e78890006fc639 0xfcdc3cb6086d5a19; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffe1f0; Value = 0x037abbc1fe01db93 0xfc336515f7b16eeb; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe1f0                       #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0x037abbc1fe01db93 0xfc336515f7b16eeb = 0x037abbc1fe01db93 0xfc336515f7b16eeb; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffe1b0; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe1b0                       #! L0x7fffffffe1b0 = L0x7fffffffe1b0; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffe1f0; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe1f0                       #! L0x7fffffffe1f0 = L0x7fffffffe1f0; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
(* add	x5, x5, x4                                  #! PC = 0x555555551318 *)
add x5 x5 x4;
(* ld1	{v15.4s-v18.4s}, [x5]                       #! EA = L0x7fffffffe230; Value = 0x07c0e6f30119d68a 0x045ac05fff12f564; PC = 0x55555555131c *)
ld1	{%%v15.4s-%%v18.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0x07c0e6f30119d68a 0x045ac05fff12f564 = 0x07c0e6f30119d68a 0x045ac05fff12f564; 0x55555555131c = 0x55555555131c;
(* add	x6, x3, #0x10                               #! PC = 0x555555551320 *)
add x6 x3 0x10@uint64;
(* lsl	x6, x6, #2                                  #! PC = 0x555555551324 *)
split dcH x6 x6 (64-2); shl x6 x6 2;
(* add	x6, x6, x4                                  #! PC = 0x555555551328 *)
add x6 x6 x4;
(* ld1	{v19.4s-v22.4s}, [x6]                       #! EA = L0x7fffffffe270; Value = 0x0476ec28000829e4 0xfd3957a00c40f9f4; PC = 0x55555555132c *)
ld1	{%%v19.4s-%%v22.4s}, %%L0x7fffffffe270                       #! L0x7fffffffe270 = L0x7fffffffe270; 0x0476ec28000829e4 0xfd3957a00c40f9f4 = 0x0476ec28000829e4 0xfd3957a00c40f9f4; 0x55555555132c = 0x55555555132c;
(* sqrdmulh	v26.4s, v16.4s, v2.4s                  #! PC = 0x555555551330 *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v26 %LO11 %LO01;
...
(* add	v26.4s, v18.4s, v22.4s                      #! PC = 0x55555555140c *)
add %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x5]                       #! EA = L0x7fffffffe230; PC = 0x555555551410 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe230                       #! L0x7fffffffe230 = L0x7fffffffe230; 0x555555551410 = 0x555555551410;
(* sub	v23.4s, v15.4s, v19.4s                      #! PC = 0x555555551414 *)
sub %v23 %v15 %v19;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551418 *)
sub %v24 %v17 %v21;
...
(* sub	v26.4s, v18.4s, v22.4s                      #! PC = 0x555555551420 *)
sub %v26 %v18 %v22;
(* st1	{v23.4s-v26.4s}, [x6]                       #! EA = L0x7fffffffe270; PC = 0x555555551424 *)
st1	{%%v23.4s-%%v26.4s}, %%L0x7fffffffe270                       #! L0x7fffffffe270 = L0x7fffffffe270; 0x555555551424 = 0x555555551424;
(* add	x3, x3, #0x20                               #! PC = 0x555555551428 *)
add x3 x3 0x20@uint64;
(* #b	0x555555551308 <p1stage4LoopStart>           #! PC = 0x55555555142c *)
#b	0x555555551308 <p1stage4LoopStart>           #! 0x55555555142c = 0x55555555142c;
...
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdeb0; Value = 0x05730e3f038b3cc7; PC = 0x5555555514f8 *)
...
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf30; Value = 0xff4077240b711c81; PC = 0x555555551508 *)
...
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffdfb0; Value = 0xf3bd8d87f666ef7b; PC = 0x555555551518 *)
...
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe030; Value = 0x0490799808b9c572; PC = 0x555555551528 *)
...
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe0b0; Value = 0xfd23df64035373ab; PC = 0x555555551538 *)
...
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe130; Value = 0xff90148d016b922a; PC = 0x555555551548 *)
...
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe1b0; Value = 0xffcd5429fc7bf5db; PC = 0x555555551558 *)
...
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe230; Value = 0x05c37c61053668e3; PC = 0x555555551568 *)
...
add %v23 %v15 %v19;
(* sub	v24.4s, v15.4s, v19.4s                      #! PC = 0x555555551640 *)
sub %v24 %v15 %v19;
(* str	q23, [x6]                                   #! EA = L0x7fffffffdeb0; PC = 0x555555551644 *)
mov L0x7fffffffdeb0 v23;
(* str	q24, [x10]                                  #! EA = L0x7fffffffe0b0; PC = 0x555555551648 *)
mov L0x7fffffffe0b0 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf30; PC = 0x555555551654 *)
mov L0x7fffffffdf30 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe130; PC = 0x555555551658 *)
mov L0x7fffffffe130 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffdfb0; PC = 0x555555551664 *)
mov L0x7fffffffdfb0 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe1b0; PC = 0x555555551668 *)
mov L0x7fffffffe1b0 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe030; PC = 0x555555551674 *)
mov L0x7fffffffe030 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe230; PC = 0x555555551678 *)
mov L0x7fffffffe230 v24;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdec0; Value = 0xfffc3f58fcf67d62; PC = 0x5555555514f8 *)
...
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf40; Value = 0x0526a992080ba082; PC = 0x555555551508 *)
...
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffdfc0; Value = 0xfb734c5efc25d943; PC = 0x555555551518 *)
...
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe040; Value = 0xfb768542ff891ced; PC = 0x555555551528 *)
...
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe0c0; Value = 0xfe241cfe05138453; PC = 0x555555551538 *)
...
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe140; Value = 0xfe0d45cc00a3bb41; PC = 0x555555551548 *)
...
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe1c0; Value = 0xff2b037205f027be; PC = 0x555555551558 *)
...
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe240; Value = 0x04b4645ffa660995; PC = 0x555555551568 *)
...
(* str	q24, [x10]                                  #! EA = L0x7fffffffe0c0; PC = 0x555555551648 *)
mov L0x7fffffffe0c0 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf40; PC = 0x555555551654 *)
mov L0x7fffffffdf40 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe140; PC = 0x555555551658 *)
mov L0x7fffffffe140 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffdfc0; PC = 0x555555551664 *)
mov L0x7fffffffdfc0 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe1c0; PC = 0x555555551668 *)
mov L0x7fffffffe1c0 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe040; PC = 0x555555551674 *)
mov L0x7fffffffe040 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe240; PC = 0x555555551678 *)
mov L0x7fffffffe240 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffded0; Value = 0x06eda96afad97ff5; PC = 0x5555555514f8 *)
...
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf50; Value = 0xff730bcf0748aefd; PC = 0x555555551508 *)
...
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffdfd0; Value = 0xf95abf78021a2347; PC = 0x555555551518 *)
...
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe050; Value = 0x053347ccfff9d1f7; PC = 0x555555551528 *)
...
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe0d0; Value = 0xfeb39bb70164915d; PC = 0x555555551538 *)
...
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe150; Value = 0x035bb58bf599a72a; PC = 0x555555551548 *)
...
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe1d0; Value = 0x0694b3b2023ac830; PC = 0x555555551558 *)
...
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe250; Value = 0x0da1ee7303546526; PC = 0x555555551568 *)
...
(* str	q24, [x10]                                  #! EA = L0x7fffffffe0d0; PC = 0x555555551648 *)
mov L0x7fffffffe0d0 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf50; PC = 0x555555551654 *)
mov L0x7fffffffdf50 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe150; PC = 0x555555551658 *)
mov L0x7fffffffe150 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffdfd0; PC = 0x555555551664 *)
mov L0x7fffffffdfd0 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe1d0; PC = 0x555555551668 *)
mov L0x7fffffffe1d0 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe050; PC = 0x555555551674 *)
mov L0x7fffffffe050 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe250; PC = 0x555555551678 *)
mov L0x7fffffffe250 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdee0; Value = 0x0a665e73fd344480; PC = 0x5555555514f8 *)
...
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf60; Value = 0x00b11ae3000f743a; PC = 0x555555551508 *)
...
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffdfe0; Value = 0x031e0c30f303bbc4; PC = 0x555555551518 *)
...
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe060; Value = 0x02536fc5fd9cd798; PC = 0x555555551528 *)
...
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe0e0; Value = 0x04ae3d0903725819; PC = 0x555555551538 *)
...
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe160; Value = 0x07dbd36efd133195; PC = 0x555555551548 *)
...
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe1e0; Value = 0x07032ff4002a3d24; PC = 0x555555551558 *)
...
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe260; Value = 0x0719d8f5fe39fb5b; PC = 0x555555551568 *)
...
(* str	q24, [x10]                                  #! EA = L0x7fffffffe0e0; PC = 0x555555551648 *)
mov L0x7fffffffe0e0 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf60; PC = 0x555555551654 *)
mov L0x7fffffffdf60 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe160; PC = 0x555555551658 *)
mov L0x7fffffffe160 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffdfe0; PC = 0x555555551664 *)
mov L0x7fffffffdfe0 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe1e0; PC = 0x555555551668 *)
mov L0x7fffffffe1e0 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe060; PC = 0x555555551674 *)
mov L0x7fffffffe060 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe260; PC = 0x555555551678 *)
mov L0x7fffffffe260 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdef0; Value = 0x0a665e730406cb03; PC = 0x5555555514f8 *)
...
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf70; Value = 0xf9a7ed5e0aafbe87; PC = 0x555555551508 *)
...
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffdff0; Value = 0xfa44fc39fca5798f; PC = 0x555555551518 *)
...
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe070; Value = 0x09f5bc9603e9792e; PC = 0x555555551528 *)
...
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe0f0; Value = 0x02c530d8028c17b7; PC = 0x555555551538 *)
...
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe170; Value = 0x072ed385fb769eaa; PC = 0x555555551548 *)
...
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe1f0; Value = 0xfddc7535fb1f27cb; PC = 0x555555551558 *)
...
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe270; Value = 0x0ae2837dffaefe23; PC = 0x555555551568 *)
...
(* str	q24, [x10]                                  #! EA = L0x7fffffffe0f0; PC = 0x555555551648 *)
mov L0x7fffffffe0f0 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf70; PC = 0x555555551654 *)
mov L0x7fffffffdf70 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe170; PC = 0x555555551658 *)
mov L0x7fffffffe170 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffdff0; PC = 0x555555551664 *)
mov L0x7fffffffdff0 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe1f0; PC = 0x555555551668 *)
mov L0x7fffffffe1f0 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe070; PC = 0x555555551674 *)
mov L0x7fffffffe070 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe270; PC = 0x555555551678 *)
mov L0x7fffffffe270 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdf00; Value = 0x06eda96aff70257c; PC = 0x5555555514f8 *)
...
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf80; Value = 0xff158736010b69da; PC = 0x555555551508 *)
...
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffe000; Value = 0xfb354c06f7e9b229; PC = 0x555555551518 *)
...
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe080; Value = 0x016d61f6039a383d; PC = 0x555555551528 *)
...
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe100; Value = 0xfd5f046401db3a8b; PC = 0x555555551538 *)
...
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe180; Value = 0x04e775e6075633eb; PC = 0x555555551548 *)
...
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe200; Value = 0x05cb102a008e2de2; PC = 0x555555551558 *)
...
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe280; Value = 0xfef4d43d015593bf; PC = 0x555555551568 *)
...
(* str	q24, [x10]                                  #! EA = L0x7fffffffe100; PC = 0x555555551648 *)
mov L0x7fffffffe100 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf80; PC = 0x555555551654 *)
mov L0x7fffffffdf80 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe180; PC = 0x555555551658 *)
mov L0x7fffffffe180 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffe000; PC = 0x555555551664 *)
mov L0x7fffffffe000 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe200; PC = 0x555555551668 *)
mov L0x7fffffffe200 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe080; PC = 0x555555551674 *)
mov L0x7fffffffe080 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe280; PC = 0x555555551678 *)
mov L0x7fffffffe280 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdf10; Value = 0xfffc3f58ff5141ed; PC = 0x5555555514f8 *)
mov v15 L0x7fffffffdf10;
(* add	x16, x16, #0x20                             #! PC = 0x5555555514fc *)
add x16 x16 0x20@uint64;
(* lsl	x7, x16, #2                                 #! PC = 0x555555551500 *)
split dcH x7 x16 (64-2); shl x7 x7 2;
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdf90; Value = 0x007f6e77011a5f3b; PC = 0x555555551508 *)
mov v16 L0x7fffffffdf90;
(* add	x16, x16, #0x20                             #! PC = 0x55555555150c *)
add x16 x16 0x20@uint64;
(* lsl	x8, x16, #2                                 #! PC = 0x555555551510 *)
split dcH x8 x16 (64-2); shl x8 x8 2;
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffe010; Value = 0xf9ffb33cffbaae0b; PC = 0x555555551518 *)
mov v17 L0x7fffffffe010;
(* add	x16, x16, #0x20                             #! PC = 0x55555555151c *)
add x16 x16 0x20@uint64;
(* lsl	x9, x16, #2                                 #! PC = 0x555555551520 *)
split dcH x9 x16 (64-2); shl x9 x9 2;
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe090; Value = 0x01e7ba260527c84d; PC = 0x555555551528 *)
mov v18 L0x7fffffffe090;
(* add	x16, x16, #0x20                             #! PC = 0x55555555152c *)
add x16 x16 0x20@uint64;
(* lsl	x10, x16, #2                                #! PC = 0x555555551530 *)
split dcH x10 x16 (64-2); shl x10 x10 2;
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe110; Value = 0xfd369e7d011e1ef5; PC = 0x555555551538 *)
mov v19 L0x7fffffffe110;
(* add	x16, x16, #0x20                             #! PC = 0x55555555153c *)
add x16 x16 0x20@uint64;
(* lsl	x11, x16, #2                                #! PC = 0x555555551540 *)
split dcH x11 x16 (64-2); shl x11 x11 2;
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe190; Value = 0x034c002bfc379d8e; PC = 0x555555551548 *)
mov v20 L0x7fffffffe190;
(* add	x16, x16, #0x20                             #! PC = 0x55555555154c *)
add x16 x16 0x20@uint64;
(* lsl	x12, x16, #2                                #! PC = 0x555555551550 *)
split dcH x12 x16 (64-2); shl x12 x12 2;
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe210; Value = 0x05ca3da4fda1b436; PC = 0x555555551558 *)
mov v21 L0x7fffffffe210;
(* add	x16, x16, #0x20                             #! PC = 0x55555555155c *)
add x16 x16 0x20@uint64;
(* lsl	x13, x16, #2                                #! PC = 0x555555551560 *)
split dcH x13 x16 (64-2); shl x13 x13 2;
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe290; Value = 0x0df5339f068b94a4; PC = 0x555555551568 *)
mov v22 L0x7fffffffe290;
(* sqrdmulh	v27.4s, v16.4s, v2.4s                  #! PC = 0x55555555156c *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
...
(* sub	v24.4s, v15.4s, v19.4s                      #! PC = 0x555555551640 *)
sub %v24 %v15 %v19;
(* str	q23, [x6]                                   #! EA = L0x7fffffffdf10; PC = 0x555555551644 *)
mov L0x7fffffffdf10 v23;
(* str	q24, [x10]                                  #! EA = L0x7fffffffe110; PC = 0x555555551648 *)
mov L0x7fffffffe110 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdf90; PC = 0x555555551654 *)
mov L0x7fffffffdf90 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe190; PC = 0x555555551658 *)
mov L0x7fffffffe190 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffe010; PC = 0x555555551664 *)
mov L0x7fffffffe010 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe210; PC = 0x555555551668 *)
mov L0x7fffffffe210 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe090; PC = 0x555555551674 *)
mov L0x7fffffffe090 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe290; PC = 0x555555551678 *)
mov L0x7fffffffe290 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
...
(* add	x6, x6, x4                                  #! PC = 0x5555555514f4 *)
add x6 x6 x4;
(* ldr	q15, [x6]                                   #! EA = L0x7fffffffdf20; Value = 0x05730e3f03aa2056; PC = 0x5555555514f8 *)
mov v15 L0x7fffffffdf20;
(* add	x16, x16, #0x20                             #! PC = 0x5555555514fc *)
add x16 x16 0x20@uint64;
(* lsl	x7, x16, #2                                 #! PC = 0x555555551500 *)
split dcH x7 x16 (64-2); shl x7 x7 2;
(* add	x7, x7, x4                                  #! PC = 0x555555551504 *)
add x7 x7 x4;
(* ldr	q16, [x7]                                   #! EA = L0x7fffffffdfa0; Value = 0x047ce02dfc4aeb0a; PC = 0x555555551508 *)
mov v16 L0x7fffffffdfa0;
(* add	x16, x16, #0x20                             #! PC = 0x55555555150c *)
add x16 x16 0x20@uint64;
(* lsl	x8, x16, #2                                 #! PC = 0x555555551510 *)
split dcH x8 x16 (64-2); shl x8 x8 2;
(* add	x8, x8, x4                                  #! PC = 0x555555551514 *)
add x8 x8 x4;
(* ldr	q17, [x8]                                   #! EA = L0x7fffffffe020; Value = 0xfe6d0fd0f6f2946c; PC = 0x555555551518 *)
mov v17 L0x7fffffffe020;
(* add	x16, x16, #0x20                             #! PC = 0x55555555151c *)
add x16 x16 0x20@uint64;
(* lsl	x9, x16, #2                                 #! PC = 0x555555551520 *)
split dcH x9 x16 (64-2); shl x9 x9 2;
(* add	x9, x9, x4                                  #! PC = 0x555555551524 *)
add x9 x9 x4;
(* ldr	q18, [x9]                                   #! EA = L0x7fffffffe0a0; Value = 0xfd7d6cc3fedd6c1a; PC = 0x555555551528 *)
mov v18 L0x7fffffffe0a0;
(* add	x16, x16, #0x20                             #! PC = 0x55555555152c *)
add x16 x16 0x20@uint64;
(* lsl	x10, x16, #2                                #! PC = 0x555555551530 *)
split dcH x10 x16 (64-2); shl x10 x10 2;
(* add	x10, x10, x4                                #! PC = 0x555555551534 *)
add x10 x10 x4;
(* ldr	q19, [x10]                                  #! EA = L0x7fffffffe120; Value = 0xfe5aa97d03d9e515; PC = 0x555555551538 *)
mov v19 L0x7fffffffe120;
(* add	x16, x16, #0x20                             #! PC = 0x55555555153c *)
add x16 x16 0x20@uint64;
(* lsl	x11, x16, #2                                #! PC = 0x555555551540 *)
split dcH x11 x16 (64-2); shl x11 x11 2;
(* add	x11, x11, x4                                #! PC = 0x555555551544 *)
add x11 x11 x4;
(* ldr	q20, [x11]                                  #! EA = L0x7fffffffe1a0; Value = 0x08b0b008fea8c8a3; PC = 0x555555551548 *)
mov v20 L0x7fffffffe1a0;
(* add	x16, x16, #0x20                             #! PC = 0x55555555154c *)
add x16 x16 0x20@uint64;
(* lsl	x12, x16, #2                                #! PC = 0x555555551550 *)
split dcH x12 x16 (64-2); shl x12 x12 2;
(* add	x12, x12, x4                                #! PC = 0x555555551554 *)
add x12 x12 x4;
(* ldr	q21, [x12]                                  #! EA = L0x7fffffffe220; Value = 0x013a463c055e04f8; PC = 0x555555551558 *)
mov v21 L0x7fffffffe220;
(* add	x16, x16, #0x20                             #! PC = 0x55555555155c *)
add x16 x16 0x20@uint64;
(* lsl	x13, x16, #2                                #! PC = 0x555555551560 *)
split dcH x13 x16 (64-2); shl x13 x13 2;
(* add	x13, x13, x4                                #! PC = 0x555555551564 *)
add x13 x13 x4;
(* ldr	q22, [x13]                                  #! EA = L0x7fffffffe2a0; Value = 0x070704170013bad1; PC = 0x555555551568 *)
mov v22 L0x7fffffffe2a0;
(* sqrdmulh	v27.4s, v16.4s, v2.4s                  #! PC = 0x55555555156c *)
smulj %LO %v16 %v2; ssplit %LO1 %LO0 %LO 31; usplit %LO00 %dc %LO0 30;
vpc %LO01@sint32[4] %LO00; vpc %LO11@sint32[4] %LO1;
add %v27 %LO11 %LO01;
...
(* sub	v24.4s, v15.4s, v19.4s                      #! PC = 0x555555551640 *)
sub %v24 %v15 %v19;
(* str	q23, [x6]                                   #! EA = L0x7fffffffdf20; PC = 0x555555551644 *)
mov L0x7fffffffdf20 v23;
(* str	q24, [x10]                                  #! EA = L0x7fffffffe120; PC = 0x555555551648 *)
mov L0x7fffffffe120 v24;
(* add	v23.4s, v17.4s, v21.4s                      #! PC = 0x55555555164c *)
add %v23 %v17 %v21;
(* sub	v24.4s, v17.4s, v21.4s                      #! PC = 0x555555551650 *)
sub %v24 %v17 %v21;
(* str	q23, [x7]                                   #! EA = L0x7fffffffdfa0; PC = 0x555555551654 *)
mov L0x7fffffffdfa0 v23;
(* str	q24, [x11]                                  #! EA = L0x7fffffffe1a0; PC = 0x555555551658 *)
mov L0x7fffffffe1a0 v24;
(* add	v23.4s, v16.4s, v20.4s                      #! PC = 0x55555555165c *)
add %v23 %v16 %v20;
(* sub	v24.4s, v16.4s, v20.4s                      #! PC = 0x555555551660 *)
sub %v24 %v16 %v20;
(* str	q23, [x8]                                   #! EA = L0x7fffffffe020; PC = 0x555555551664 *)
mov L0x7fffffffe020 v23;
(* str	q24, [x12]                                  #! EA = L0x7fffffffe220; PC = 0x555555551668 *)
mov L0x7fffffffe220 v24;
(* add	v23.4s, v18.4s, v22.4s                      #! PC = 0x55555555166c *)
add %v23 %v18 %v22;
(* sub	v24.4s, v18.4s, v22.4s                      #! PC = 0x555555551670 *)
sub %v24 %v18 %v22;
(* str	q23, [x9]                                   #! EA = L0x7fffffffe0a0; PC = 0x555555551674 *)
mov L0x7fffffffe0a0 v23;
(* str	q24, [x13]                                  #! EA = L0x7fffffffe2a0; PC = 0x555555551678 *)
mov L0x7fffffffe2a0 v24;
(* add	x3, x3, #0x4                                #! PC = 0x55555555167c *)
add x3 x3 0x4@uint64;
(* #b	0x555555551434 <p1stage5LoopStart>           #! PC = 0x555555551680 *)
#b	0x555555551434 <p1stage5LoopStart>           #! 0x555555551680 = 0x555555551680;
